...
@property (weak, readonly) SearchViewCell *searchViewCell;
@property (nonatomic, strong) NSMutableArray *filteredSections;
@property (strong, nonatomic) UITableViewCell *committeeHeaderView;
